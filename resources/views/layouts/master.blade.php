                        ...
                        <div class="nav-header">
                            <a href="{{ route('home') }}" class="brand-logo">
                                <div class="deskContent ">
                                    <img src="/assets/logo-4.png" alt="" width="150" >
                                    {{-- <h3>PassMan</h3> --}}
                                </div>
                                <div class="phoneContent">
                                    <img src="/assets/logo-4.png" alt="" width="75">
                                </div>
                                                    ...
                                                    ***********************************-->
                                                    ...
                                                    <!--**********************************
                                                        ...
                                                        ***********************************-->
                                                        <div class="footer">
                                                            <div class="copyright">
                                                                <p>Copyright © Designed &amp; Developed by <a href="https://joreb.net" target="_blank">JOREB</a> {{ now()->format('Y') }}</p>
                                                            </div>
                                                        </div>
                                                        <!--**********************************
                                                            Footer end
